...
export function buildVerification(token) {
    return `<!DOCTYPE html>
    <html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" style="color-scheme: light dark; width: 100%; max-width: 100%; overflow-x: hidden; height: 100%">
    <head>
      <meta charset="utf-8">
      ...
      <![endif]-->    <title>Confirm your email address</title>
      <style>:root {
    ...
    <body style="max-width: 100%; overflow-x: hidden; height: 100%; -webkit-font-smoothing: antialiased; word-break: break-word; margin: 0; width: 100%; padding: 0; color: #3eb9e5">    <div style="display: none">
              ...
              <table class="sm-w-full" style="width: 600px" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td class="sm-py-8 sm-px-6" style="padding: 48px; text-align: center">
                    <a href="disepvp.ee">
                      <img src="https://disepvp.ee/img/logo.png" width="100" alt="disepvp" style="border: 0; max-width: 100%; vertical-align: middle">
                    </a>
                  </td>
                </tr>
                <tr>
                  <td align="center" class="sm-px-6">
                    <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                      <tr>
                        <td class="sm-px-6" style="border-radius: 4px; background-color: rgba(0,0,0,0.6); padding: 48px; text-align: left; font-size: 16px; line-height: 24px; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
                          <p>
                            Привет игрок!
                          </p>
                          ...
                          <div style="line-height: 100%">
                            <a href="${process.env.BASE_URL}/verify/${token}" style="cursor: pointer">
                              <!--[if mso]>
                                <i style="mso-text-raise: 30px; letter-spacing: 24px">&#8202;</i>
                              <![endif]-->
                              <button style="margin-top: 4px; margin-bottom: 4px; color: #3eb9e5; border-width: 1px; border-color: #fc6f53; border-radius: 6px; padding: 8px; mso-text-raise: 16px; background-color: #101010; cursor: pointer">Подтвердить почту &rarr;</button>
                              <!--[if mso]>
